...
class Tags:
    ...
    D_TWEETS_GRT = Tag(func_src=lambda: DB.main.get_from_json('from:loos:json:tweets:@grtgaz'), refresh=2.0)
    L_FLYSPRAY_RSS = Tag(func_src=lambda: DB.main.get_from_json('from:loos:json:flyspray-est'), refresh=2.0)
    ...
    IMG_GRT_CLOUD = Tag(func_src=lambda: DB.main.get_bytes('from:loos:img:grt-twitter-cloud:png'), refresh=10.0)
